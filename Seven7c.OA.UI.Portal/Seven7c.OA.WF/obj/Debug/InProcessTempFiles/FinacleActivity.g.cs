...
namespace Seven7c.OA.WF {
    ...
    public partial class FinacleActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(FinacleActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(FinacleActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(FinacleActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".FinacleActivity.g.xaml") || resource.Equals("FinacleActivity.g.xaml"))) {
                    return resource;
                }
            }
